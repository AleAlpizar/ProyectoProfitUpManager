...
public class AuthService
{
    ...
    public static string HashPassword(string password, string? salt, int iter = 100_000)
    {
        ...
        var hash = Rfc2898DeriveBytes.Pbkdf2(password, Convert.FromBase64String(salt),
    ...
    public static bool VerifyPassword(string password, string stored)
    {
        ...
        var computed = Rfc2898DeriveBytes.Pbkdf2(password, Convert.FromBase64String(salt),
